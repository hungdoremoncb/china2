<?php /*a:1:{s:71:"/www/wwwroot/103.77.173.23/application/index/view/my/invite-orange.html";i:1662769862;}*/ ?>
<!DOCTYPE html><html data-dpr="1" style="font-size: 32px;"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1" /><meta name="apple-mobile-web-app-capable" content="yes" /><meta content="telephone=yes" name="format-detection" /><meta name="apple-mobile-web-app-status-bar-style" content="white" /><meta name="x5-fullscreen" content="true" /><meta name="apple-touch-fullscreen" content="yes" /><title><?php echo lang('推广海报'); ?></title><link href="/web/css/orange.css" rel="stylesheet" /><link rel="stylesheet" href="/static_new/css/public.css"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script></head><body style="font-size: 12px;" class="bjs"><div id="app" ><div data-v-268420fc="" class="main"><div data-v-268420fc="" class="header"><div class="left_btn" onclick="window.history.back(-1)"><img src="/web/img/Yjian.png"  alt="" class="return" /></div><div class="Maintitle"><h3><?php echo lang('推广海报'); ?></h3></div><div class="right_btn"></div></div><div data-v-268420fc="" class="box"><h1 data-v-268420fc="" ><?php echo lang('邀好友赚现金'); ?></h1><div data-v-268420fc="" class="top"></div><div class="promote-wrpa"><div class="yaoqing_top"><?php echo lang('二维码'); ?></div><div data-v-268420fc="" class="user" style="display: block;text-align: center;"><div id="qrcode" class="ewm qr" ></div><script type="text/javascript" src="/statics/js/jquery.qrcode.min.js"></script><script>
jQuery('#qrcode').qrcode({
    ...
    text: "<?php echo htmlentities($url); ?>"
               ...
               value=""></div><div data-v-268420fc="" class="copy" style="display: block;background-color: #FF8828" onclick="copy_txt('<?php echo htmlentities($url); ?>')"><?php echo lang('邀请链接:点击复制'); ?></div></div></div></div></body><script>
